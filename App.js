...
app.get('/t2/a', function (req, res) {
    res.sendFile(publicPath + '/t2/a.html');
});

app.get('/t2/b', function (req, res) {
    res.sendFile(publicPath + '/t2/b.html');
});

app.get('/t2/c', function (req, res) {
    res.sendFile(publicPath + '/t2/c.html');
});

app.get('/t2/d', function (req, res) {
    res.sendFile(publicPath + '/t2/d.html');
});
